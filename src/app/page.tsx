						...
						<div className='mt-10 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-full sm:w-[90vw] md:w-[80vw] mx-auto px-4 sm:px-8 md:px-0 pb-8'>
							...
							<div className='bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 hover:bg-white/15 transition-all duration-300 border border-white/5 flex flex-col h-full'>
								<div>
									...
									<p className='text-white/70 text-sm leading-relaxed flex-grow'>Sync your database schema directly with your codebase using simple terminal commands. Available soon.</p>
								</div>
								<div className='mt-auto pt-4'>
									<div className='flex items-center gap-2'>
										<div className='flex items-center gap-1'>
							...
							<div className='bg-white/10 backdrop-blur-sm rounded-xl p-4 sm:p-6 hover:bg-white/15 transition-all duration-300 border border-white/5 flex flex-col h-full'>
								<div>
									...
									<p className='text-white/70 text-sm leading-relaxed flex-grow'>Start with pre-built database schemas and customize them to match your project needs. Save development time.</p>
								</div>
								<div className='mt-auto pt-4'>
									<div className='flex items-center gap-2'>
										<div className='flex items-center gap-1'>
