...
const Home = () => {
	...
	return (
		<>
			<div className="bg-primary relative z-1 max-w-screen  min-h-screen overflow-x-hidden">
				<div className='h-full w-full absolute top-0 left-0 z-0'><Squares
					speed={0.1}
					squareSize={40}
				...
				<section className="relative z-10 flex items-center max-w-screen h-screen">
					<div className="flex items-center justify-around flex-col w-full">
						...
						<div className='mt-10 grid grid-cols-3 gap-10 w-[80vw]'>
							<div className='bg-white/50 h-96 w-full'>
								<p>open source</p>
							</div>
							<div className='bg-white/50 h-96 w-full'>
